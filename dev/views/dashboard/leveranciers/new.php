...
<div class="container-fluid justify-content-center" style="margin-top:-40px;">
    <div class="row px-3 px-md-5 justify-content-between">
        <div class="p-0 col-12 col-xl-9 pr-xl-4 mb-4">
            <div class="card shadow" id="supplier_info">
                <div class="card-header border-0 bg-white rounded-top p-3">
                    <div class="row px-4 align-items-center justify-content-between">
                        <ol class="breadcrumb bg-white m-0 p-0">
                            <li class="breadcrumb-item active">Nieuw leverancier</li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-12 col-xl-3 pl-md-3 pr-md-3">
            <form class="row" novalidate>
                <div class="col-12 p-0">
                    <div class="card shadow " id="supplier_contact">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item p-0 py-2">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Leveranciersnaam"
                                                       aria-label="Leveranciersnaam" id="name" required>
                                            </div>
                                        </li>
                                        <li class="list-group-item p-0 py-2">
                                            <div class="input-group">
...
<script>
    ...
    tinymce.triggerSave();
        <?php if($usertheme->data['theme'] == 2) {
        ?>
       'change', function () {
            this.contentDocument.body.style.cssText = 'color:#ffffff!important';
        });
        <?php
        }
        ...
        $.ajax({ //Process the form using $.ajax()
            ...
            url: '/controllers/tables/supplier/supplier_save.php', //Your form processing file URL
            data: {
            ...
            success: function (data) {
                ...
                if (data.status === 'success') {
                    window.location.href = '/leveranciers';
                } else {
...
<script src="/assets/js/dashboard/tables/supplier/suppliers.js"></script>
