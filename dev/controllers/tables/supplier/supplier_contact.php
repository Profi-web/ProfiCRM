...
//
?>
<form class="p-0 m-0" id="supplier_contact_form" novalidate>
                    ...
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="tel" class="form-control" placeholder="Bedrijfsnaam" aria-label="Bedrijfsnaam"
                                   id="name" value="<?php echo $supplier->getData('name'); ?>" required>
                        </div>
                    </li>
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="tel" class="form-control" placeholder="Telefoonnummer"
                                   ...
                                   id="phonenumber" value="<?php echo $supplier->getData('phonenumber'); ?>" name="tel">
                        </div>
                    </li>
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control" placeholder="Email" aria-label="Email" id="email" name="email"
                                   value="<?php echo $supplier->getData('email'); ?>">
                        </div>
                    </li>
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Adres" aria-label="Adres" id="address"
                                   value="<?php echo $supplier->getData('address'); ?>">
                        </div>
                    </li>
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Postcode" aria-label="Postcode"
                                   id="zipcode" value="<?php echo $supplier->getData('zipcode'); ?>">
                        </div>
                    </li>
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Stad" aria-label="Stad" id="city"
                                   value="<?php echo $supplier->getData('city'); ?>">
                        </div>
                    </li>
                </ul>
...
<script>
    ...
    $('#supplier_contact_form').submit(function (event) {
        if ($('#name').val() === '') {
        ...
        $.ajax({ //Process the form using $.ajax()
            ...
            url: '/controllers/tables/supplier/supplier_contact_save.php?id=<?php echo $id;?>', //Your form processing file URL
            data: {
                name: $('#name').val(),
