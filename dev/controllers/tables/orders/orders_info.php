...
<div class="card-header border-0 bg-white rounded-top p-3">
    <div class="row px-4 align-items-center justify-content-between">
        <ol class="breadcrumb bg-white m-0 p-0">
            <li class="breadcrumb-item"><a href="../../../index.php">bestellingen</a></li>
            <li class="breadcrumb-item active" aria-current="page">#<?php echo $order->getData('id'); ?></li>
        </ol>
    </div>
</div>
<div class="container-fluid  bg-light-second py-3 rounded-bottom">
    <div class="row p-3">
        <div class="col-12">
            ...
            <textarea rows="35" id="input_data"><?php echo nl2br($order->getData('text')); ?></textarea>
...
<script>
    ...
    tinymce.triggerSave();
        ...
        $.ajax({ //Process the form using $.ajax()
            ...
            url: '/controllers/tables/orders/orders_info_save.php?id=<?php echo $id;?>', //Your form processing file URL
