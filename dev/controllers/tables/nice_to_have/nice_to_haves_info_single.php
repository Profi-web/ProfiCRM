...
<div class="card-header border-0 bg-white rounded-top p-3">
    <div class="row px-4 align-items-center justify-content-between">
        <ol class="breadcrumb bg-white m-0 p-0">
            <li class="breadcrumb-item"><a href="../../../nice-to-haves">Nice to haves</a></li>
            <li class="breadcrumb-item active"
                aria-current="page"><?php echo $nice_to_have->getData('title'); ?></li>
        </ol>
    ...
    <div class="row p-3">
        <div class="col-12">
            ...
            <div class="bg-white p-3 rounded">
                <?php echo nl2br($nice_to_have->getData('text')); ?>
            </div>
...
<script>
    $('.trigger_info').on('click', function () {
        $('#nice_to_haves_info').load('/controllers/tables/nice_to_have/nice_to_haves_info.php?id=<?php echo $id; ?>', function () {
        });
    });
</script>