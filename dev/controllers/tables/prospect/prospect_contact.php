...
//
?>
<form class="p-0 m-0" id="prospect_contact_form" novalidate>
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="tel" class="form-control" placeholder="Prospectsnaam" aria-label="Prospectsnaam"
                                   id="name" value="<?php echo $prospect->getData('name'); ?>" required>
                        </div>
                    </li>
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="tel" class="form-control" placeholder="Telefoonnummer"
                                   ...
                                   id="phonenumber" value="<?php echo $prospect->getData('phonenumber'); ?>" name="tel">
                        </div>
                    </li>
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control" placeholder="Email" aria-label="Email" id="email" name="email"
                                   value="<?php echo $prospect->getData('email'); ?>">
                        </div>
                    </li>
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="website" aria-label="website" id="website" name="website"
                                   value="<?php echo $prospect->getData('website'); ?>">
                        </div>
                    </li>
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Contactpersoon" aria-label="Contactpersoon" id="contactpersoon"
                                   value="<?php echo $prospect->getData('contactpersoon'); ?>">
                        </div>
                    </li>
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Adres" aria-label="Adres" id="address"
                                   value="<?php echo $prospect->getData('address'); ?>">
                        </div>
                    </li>
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Postcode" aria-label="Postcode"
                                   id="zipcode" value="<?php echo $prospect->getData('zipcode'); ?>">
                        </div>
                    </li>
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Stad" aria-label="Stad" id="city"
                                   value="<?php echo $prospect->getData('city'); ?>">
                        </div>
                    </li>
                    <li class="list-group-item p-0 py-2">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="KvK" aria-label="KvK" id="kvk"
                                   value="<?php echo $prospect->getData('kvk'); ?>">
                        </div>
                    </li>
                </ul>
...
<script>
    $('#back_contact').on('click',function () {
        $('#prospect_contact').load('/controllers/tables/prospect/prospect_contact_single.php?id=<?php echo $id; ?>', function () {
        });
    });
    $('#prospect_contact_form').submit(function (event) {
        if ($('#name').val() === '') {
        ...
        $.ajax({ //Process the form using $.ajax()
            ...
            url: '/controllers/tables/prospect/prospect_contact_save.php?id=<?php echo $id;?>', //Your form processing file URL
            data: {
                name: $('#name').val(),
