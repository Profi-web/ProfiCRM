...
<div class="container-fluid  bg-light-second py-3 rounded-bottom">
    <div class="row p-3">
        <div class="col-12">
            ...
            <textarea rows="35" id="input_data"><?php echo nl2br($article->getData('text')); ?></textarea>
...
<script>
    ...
    tinymce.triggerSave();
        ...
        $.ajax({ //Process the form using $.ajax()
            ...
            url: '/controllers/tables/articles/articles_info_save.php?id=<?php echo $id;?>', //Your form processing file URL
