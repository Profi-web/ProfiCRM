...
/*Classes*/
$table = new TableOrdersCompany($paginationOrders, 'orders', 'bedrijf',$id);
$orders = new Orders('', $table->limit);
$loginValidate = new validateLogin();
$loginValidate->securityCheck();
$search = $orders->findAllId($table->startfrom, $table->limit, $id,1);
...
<div class="card-header border-0 bg-white rounded-top p-4">
    <div class="row px-4 align-items-center justify-content-between">
        ...
        <a class="btn btn-info rounded text-white" href="/bestellingen/nieuw?relation=<?php echo urlencode($company->getData('name')); ?>">Nieuwe bestelling</a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body">
                                                <div class="alert_field_status_order_<?php echo $order['id'] ?>">
                                                </div>
...
<script>
        ...
        $.ajax({ //Process the form using $.ajax()
            ...
            success: function (data) {
                ...
                if (data.status === 'success') {
                    ...
                    $('#company_orders').load('/controllers/tables/company/company_orders.php?pageOrders=' + page + '&id=' + id, function () {
                    });
                } else {
                    $(".alert_field_status_order_"+factureringsID).load("/controllers/error.php", {
    ...
    $('tbody.order_table .tr_click').on('click', function e() {
