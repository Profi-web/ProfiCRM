...
<div class="container-fluid justify-content-center" style="margin-top:-40px;">
    <div class="row px-3 px-md-5 justify-content-between">
        <div class="p-0 col-12 col-xl-9 pr-xl-4 mb-4">
            <div class="card shadow" id="nice_to_haves_info">
                <div class="card-header border-0 bg-white rounded-top p-3">
                    <div class="row px-4 align-items-center justify-content-between">
                        <ol class="breadcrumb bg-white m-0 p-0">
                            <li class="breadcrumb-item active">Nieuwe nice to have</li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-12 col-xl-3 pl-md-3 pr-md-3">
            <form class="row" novalidate>
                <div class="col-12 p-0">
                    <div class="card shadow " id="nice_to_haves_contact">
                                        ...
                                        <li class="list-group-item p-0 py-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="custom-select rounded" id="status" name="status">
                                                    <option <?php if ($nice_to_have->getData('status') == '1') {
                                                        echo 'selected';
                                                    } ?> value="1">Open
                                                    </option>
                                                    <option <?php if ($nice_to_have->getData('status') == '2') {
                                                        echo 'selected';
                                                    } ?> value="2">Uitgevoerd
                                                    </option>
                                                </select>
                                        ...
                                        <li class="list-group-item p-0 py-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="custom-select rounded" id="priority" name="priority">
                                                    <option <?php if ($nice_to_have->getData('priority') == '1') {
                                                        echo 'selected';
                                                    } ?> value="1">Laag
                                                    </option>
                                                    <option <?php if ($nice_to_have->getData('priority') == '2') {
                                                        echo 'selected';
                                                    } ?> value="2">Middel
                                                    </option>
                                                    <option <?php if ($nice_to_have->getData('priority') == '3') {
                                                        echo 'selected';
                                                    } ?> value="3">Hoog
                                                    </option>
...
<script>
    ...
    $('form').submit(function (event) {
        ...
        if ($('#priority').val() == '') {
            ...
            $('#priority').addClass('is-valid');
        }

        $.ajax({ //Process the form using $.ajax()
            type: 'POST', //Method type
            url: '/controllers/tables/nice_to_have/nice_to_haves_save.php', //Your form processing file URL
            data: {
            ...
            success: function (data) {
                ...
                if (data.status === 'success') {
                    window.location.href = '/nice-to-haves';
                } else {
